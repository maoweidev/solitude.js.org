...
```
  ...
  1. 新建 `[根目录]/sw-rules.js` 文件，并新增以下内容
...
```
  1. 全部步骤操作完成后，你可以通过 Chrome 控制台的 Lighthouse 检查 PWA 配置是否生效以及配置是否正确。
  ::
  ::div
  ---
  label: 素材
...
<br/>
具体详见：[Issue #144 的解决方案](https://github.com/everfu/hexo-theme-solitude/issues/144#issuecomment-1986869454)
::

> CDN 配置借鉴 Butterfly 的实现
